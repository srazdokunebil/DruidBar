...
function DruidBar_MaxManaScript()
			...
			for i = 1, 18 do
				...
				for j = 1, DBarSpellCatch:NumLines() do
					...
					if strchek then
						--print('strchek: '.. strchek);
						if string.find(strchek, DRUIDBAR_REGEN1) then
							DruidBarKey.extra = DruidBarKey.extra + string.gsub(strchek, DRUIDBAR_REGEN3, "%1");
						end

						-- atiesh
						if string.find(strchek, DRUIDBAR_REGEN5) then
							DruidBarKey.extra = DruidBarKey.extra + string.gsub(strchek, DRUIDBAR_REGEN6, "%1");
						end

						-- brilliant mana oil
						if string.find(strchek, DRUIDBAR_REGEN7) then
							DruidBarKey.extra = DruidBarKey.extra + 12;
						end
