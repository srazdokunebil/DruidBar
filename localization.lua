...
DRUIDBAR_REGEN5 = "Equip: Restores %d+ mana per 5 seconds to all party members within 30 yards.";
DRUIDBAR_REGEN6 = "Equip: Restores (%d+) mana per 5 seconds to all party members within 30 yards."
DRUIDBAR_REGEN7 = "Brilliant Mana Oil";
